        ...
        if(pressID == R.id.button5) {
            ...
            if(!text.isEmpty()) {
                ...
                if(textChunks.length == 3){
                    if(textChunks[1].equals("+")){
                        result = Double.parseDouble(textChunks[0]) + Double.parseDouble(textChunks[2]);
                    }
                    if(textChunks[1].equals("-")){
                        result = Double.parseDouble(textChunks[0]) - Double.parseDouble(textChunks[2]);
                    }
                ...
                else if(textChunks.length == 1 || textChunks.length == 2) {
                    resultText.setText(textChunks[0]);
                }
                else{
                        resultText.setText("ERROR");
                }
